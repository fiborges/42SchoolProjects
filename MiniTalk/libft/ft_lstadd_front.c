...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/02 17:12:18 by filipa            #+#    #+#             */
/*   Updated: 2022/11/03 12:06:48 by firibeir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	my_tlist = (t_list *)malloc(sizeof(t_list) * 5);
 	...
 	ft_lstadd_front(&my_tlist, linked_list1);
 	ft_lstadd_front(&my_tlist, linked_list2);
