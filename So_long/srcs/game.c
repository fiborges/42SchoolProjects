...
/*   Updated: 2023/03/14 15:52:16 by firibeir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	if (fill_map()->map[game()->p_pos_y
			+ y_mov][game()->p_pos_x + x_mov] == '0'
			|| fill_map()->map[game()->p_pos_y + y_mov]
			[game()->p_pos_x + x_mov] == 'C')
	{
		if (fill_map()->map[game()->p_pos_y
				+ y_mov][game()->p_pos_x + x_mov] == 'C')
			game()->collected_coll++;
