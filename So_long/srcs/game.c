...
/*   Updated: 2023/04/03 09:36:47 by filipa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void move_charater(int y_mov, int x_mov)
{
    ...
    {
        // Allow passing through the exit tile when all collectibles are not collected yet
    ...
    else if (fill_map()->map[game()->p_pos_y + y_mov][game()->p_pos_x + x_mov] == '0' || fill_map()->map[game()->p_pos_y + y_mov][game()->p_pos_x + x_mov] == 'C')
    {
